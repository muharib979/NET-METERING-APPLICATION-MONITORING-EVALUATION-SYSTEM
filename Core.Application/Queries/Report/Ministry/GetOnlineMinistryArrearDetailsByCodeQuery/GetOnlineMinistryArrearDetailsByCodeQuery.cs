...
namespace Core.Application.Queries.Report.Ministry.GetOnlineMinistryArrearDetailsByCodeQuery
{
    public class GetOnlineMinistryArrearDetailsByCodeQuery: IRequest<List<OnlineMinistryArrearDetailsMergeDTO>>
    {
        ...
        public class Handler : IRequestHandler<GetOnlineMinistryArrearDetailsByCodeQuery, List<OnlineMinistryArrearDetailsMergeDTO>>
        {
            ...
            public async Task<List<OnlineMinistryArrearDetailsMergeDTO>> Handle(GetOnlineMinistryArrearDetailsByCodeQuery request, CancellationToken cancellationToken)
            {
                List<OnlineMinistryArrearDetailsMergeDTO>? result = await _ministryRepository.OnlineMinistyArrearDetailsByCode(request.BillMonth, request.MinistryCode, request.ZoneCode, request.LocationCode, request.ReportType);
