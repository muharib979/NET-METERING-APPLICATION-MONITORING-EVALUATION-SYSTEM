...
namespace Core.Application.Queries.Report.Ministry
{
    public class GetAllOnlineCRVPaymentDetailsQuery:IRequest<List<OnlineMinistryArrearDetailsMergeDTO>>
    {
        ...
        public class Handler : IRequestHandler<GetAllOnlineCRVPaymentDetailsQuery, List<OnlineMinistryArrearDetailsMergeDTO>>
        {
            ...
            public async Task<List<OnlineMinistryArrearDetailsMergeDTO>> Handle(GetAllOnlineCRVPaymentDetailsQuery request, CancellationToken cancellationToken)
            {
