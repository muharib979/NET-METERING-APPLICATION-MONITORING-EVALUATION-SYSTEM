...
{
    public class GetOnlineCityAndPouroCodeWiseCityAndPouroDataQuery : IRequest<OnlineCityPourDataListModel>
    {
        ...
        public class Handler : IRequestHandler<GetOnlineCityAndPouroCodeWiseCityAndPouroDataQuery, OnlineCityPourDataListModel>
        {
            ...
            public async Task<OnlineCityPourDataListModel> Handle(GetOnlineCityAndPouroCodeWiseCityAndPouroDataQuery request, CancellationToken cancellationToken)
            {
                ...
                {
                    var detailsResult = _mapper.Map<List<OnlineCityPourMergeDTO>>(await _cityCorporationRepository.GetOnlinePouroAndCityCodeWiseBnDetails(request.BillMonth, request.ZoneCode, request.LocationCode, request.CityCorporationCode, request.PouroshovaCode));
                ...
                // return new OnlineCityPourDataListModel();
            }
        }
