...
{
    public class GetAllOnlineCityCorporAndPouroBnQueryList: IRequest<OnlineCityPourDataListModel>
    {
        ...
        public class Handler : IRequestHandler<GetAllOnlineCityCorporAndPouroBnQueryList, OnlineCityPourDataListModel>
        {
            ...
            public async Task<OnlineCityPourDataListModel> Handle(GetAllOnlineCityCorporAndPouroBnQueryList request, CancellationToken cancellationToken)
            {
                ...
                {
                    var detailsResult = _mapper.Map<List<OnlineCityPourMergeDTO>>(await _cityCorporationRepository.GetAllOnlinePouroAndCityCorpoBnDetails(request.BillMonth, request.ZoneCode, request.LocationCode));
