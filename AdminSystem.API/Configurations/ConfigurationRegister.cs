namespace CFEMS.API.Configurations;
    ...
    internal static ConfigureHostBuilder AddConfigurations(this ConfigureHostBuilder host)
    {
        host.ConfigureAppConfiguration((context, config) =>
        {
            ...
            config.AddJsonFile("appsettings.json", optional: false, reloadOnChange: true)
                ...
                .AddJsonFile($"{configurationsDirectory}/channelapi.json", optional: false, reloadOnChange: true)
                .AddJsonFile($"{configurationsDirectory}/channelapi.{env.EnvironmentName}.json", optional: true, reloadOnChange: true)
                .AddJsonFile($"{configurationsDirectory}/paymentgateway.json", optional: false, reloadOnChange: true)
                .AddJsonFile($"{configurationsDirectory}/paymentgateway.{env.EnvironmentName}.json", optional: true, reloadOnChange: true)
