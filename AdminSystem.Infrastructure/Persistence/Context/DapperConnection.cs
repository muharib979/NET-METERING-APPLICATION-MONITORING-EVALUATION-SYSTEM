...
namespace AdminSystem.Infrastructure.Persistence.Context
{
    public class Connection
    {
        ...
        private static string _connectionStringbillTrans;
        private static string _connectionStringConsumerBill;
        private static string _connectionStringConsumerBillTrans;
        ...
        public static void Initialize(ConnectionString connectionString)
        {
            ...
            _connectionString = $" {connectionString.Server}";
            _connectionStringbillTrans = $" {connectionString.MiscTransfer}";
            _connectionStringConsumerBill = $" {connectionString.ConsumerBill}";
            _connectionStringConsumerBillTrans = $" {connectionString.ConsumerBillTranfer}";
        ...
        public static string ConnectionStringMiscBillTransfer()
        {
            return _connectionStringbillTrans;
        }
        public static string ConnectionStringConsumerBill()
        {
            return _connectionStringConsumerBill;
        }
        public static string ConnectionStringConsumerBillTrans()
        {
            return _connectionStringConsumerBillTrans;
        }
